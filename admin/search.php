...
if (isset($_GET['search']) && isset($_GET['submit'])) {
    ...
    header('location:' . ROOT_URL . 'admin/shop.php');
    die();
}
...
<section class="search_bar section-p1" >
    <form action="<?= ROOT_URL ?>admin/search.php" method="GET" class="search_bar-container">
        <div>
            <input type="search" name="search" placeholder="Enter a keyword to filter">
        </div>
...
<section id="product1" class="section-p1">
    ...
    <div class="product-container">
        ...
        <div class="product">
        <form action="<?= ROOT_URL ?>cart-logic.php" method="POST" enctype="multipart/form-data"> 
...
<?php else : ?>
    <div class="bg-danger p-2">
         <p><?= "Your Search did not match an item. Please try another keyword" ?></p> 
    </div>
